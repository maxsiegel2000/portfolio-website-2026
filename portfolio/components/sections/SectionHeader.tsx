...
function SectionHeader({
  ...
  const renderPillIcon = () => {
    ...
    switch (pillIcon) {
      case "project":
        return <FolderCodeIcon {...common} />;
      case "bot":
        return <BotMessageSquareIcon {...common} />;
      case "tool":
        return <WrenchIcon {...common} />;
      default:
        return <ConnectIcon {...common} />;
    }
  };
  return (
    <RevealGroup
        ...
        <RevealItem>
          <motion.div
            ...
            whileHover={{
              ...
              backgroundImage:
                "linear-gradient(135deg, rgba(53,186,231,.2), rgba(32,79,215,.2))",
