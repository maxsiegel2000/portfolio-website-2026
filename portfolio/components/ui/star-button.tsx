...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 z-[4] overflow-hidden rounded-[inherit] border text-secondary  dark:text-black"
        style={{ borderWidth: "var(--border-width)" }}
        aria-hidden="true"
      >
        <StarBackground color={starColor} />
      </div>
      <span className="relative z-10 inline-block bg-clip-text text-primary">
        {children}
      </span>
    </button>
  )
